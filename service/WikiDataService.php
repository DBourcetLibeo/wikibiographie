...
class WikiDataService
{
    ...
    protected static function fetchBaseInfo($wikipediaUrl): array
    {
        ...
        return [
            'name' => $body['results']['bindings'][0]['itemLabel']['value'],
    ...
    protected static function fetchImageUrl(string $entityId): ?string
    {
        ...
        if (empty($fileName)) { return 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Defaut_2.svg/langfr-260px-Defaut_2.svg.png'; }
