...
<table id="wikibiographie-metabox-table">
    ...
    <tr>
        <td>
            <label for=""><?php _e("Nom et prénom", 'wikibiographie'); ?></label>
            <div class="wiki">
                <input type="text" name="_biographie_wiki_name" value="<?php echo !empty($meta_data['_biographie_wiki_name']) ? $meta_data['_biographie_wiki_name'] : null ?>" readonly>
            </div>
        </td>
        <td>
            <label for=""><?php _e("Nom et prénom", 'wikibiographie'); ?></label>
            <input type="text" name="_biographie_custom_name" value="<?php echo !empty($meta_data['_biographie_custom_name']) ? $meta_data['_biographie_custom_name'] : null ?>">
        </td>
    </tr>
    <tr>
        <td>
